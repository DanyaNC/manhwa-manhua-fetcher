...
def parse_csv():
    """
    Open and read a csv file that contains the list of comics, which should contain
    these 3 values separated by a delimiter for each comic, Name, Latest_Chapter, URL
    Each line should contain 1 comic, 3 values.
    Parse the data line by line (comic by comic) and create a new Comic object for each line.
    """
