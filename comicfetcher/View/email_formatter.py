...
with open('comicfetcher/View/html_templates/pre_image.html', 'r', encoding='utf-8') as f:
    pre_image_html = f.read()

with open('comicfetcher/View/html_templates/post_image.html', 'r', encoding='utf-8') as f:
    post_image_html = f.read()

with open('comicfetcher/View/html_templates/post_name.html', 'r', encoding='utf-8') as f:
    post_name_html = f.read()

with open('comicfetcher/View/html_templates/post_chapters.html', 'r', encoding='utf-8') as f:
    post_chapter_html = f.read()

with open('comicfetcher/View/html_templates/banner.html', 'r', encoding='utf-8') as f:
    banner_html = f.read()

with open('comicfetcher/View/html_templates/closer.html', 'r', encoding='utf-8') as f:
    closer_html = f.read()
